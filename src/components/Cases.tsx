      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-14">
          {formats.map((fmt, idx) => (
            <div
              key={idx}
              className="group p-7 rounded-[24px] bg-white border border-[#EBEBEB] hover:shadow-xl hover:border-black/30 transition-all duration-300 flex flex-col justify-between space-y-5 relative overflow-hidden"
            >
