...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-14 md:py-20 bg-[#FAFAFA] relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="relative max-w-[400px] mx-auto lg:max-w-none">
              <div className="w-full aspect-[4/5] rounded-[32px] overflow-hidden shadow-2xl border border-[#EBEBEB] bg-[#F5F5F5]">
                <img
              ...
              {/* Quote Card */}
              <div className="mt-4 sm:mt-0 sm:absolute sm:-bottom-6 sm:-right-6 w-full sm:w-4/5 p-5 rounded-2xl bg-white border border-[#EBEBEB] shadow-xl space-y-3">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-8">
            ...
            <div className="space-y-4 text-base text-[#737373] leading-relaxed">
              <p>
