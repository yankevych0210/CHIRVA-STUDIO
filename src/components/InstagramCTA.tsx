...
export const InstagramCTA: React.FC = () => {
  return (
    <section id="contact" className="py-14 md:py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ background: igGradient }} />
      ...
      />
      {/* Soft light orbs */}
      <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-white/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-white/8 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center">
            <div className="w-20 h-20 rounded-[28px] bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center shadow-xl">
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center gap-3 bg-white text-[#1A1A1A] font-semibold text-sm px-9 py-4 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-xl"
            >
              <InstagramIcon className="w-5 h-5" style={{ color: '#dc2743' }} />
